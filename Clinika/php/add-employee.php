...
if (isset($_REQUEST['add-employee'])) {
    ...
    $insert_query = mysqli_query($connection, "INSERT INTO tbl_employee (first_name, last_name, username, emailid, password, dob, employee_id, joining_date, gender, phone, address, bio, role, status) VALUES ('$first_name', '$last_name', '$username', '$emailid', '$pwd', '$dob', '$employee_id', '$joining_date', '$gender', '$phone', '$address', '$bio', '$role', '$status')");
