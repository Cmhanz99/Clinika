...
if (isset($_REQUEST['add-schedule'])) {
    ...
    $insert_query = mysqli_query($connection, "INSERT INTO tbl_schedule (doctor_name, available_days, start_time, end_time, message, status) VALUES ('$doctor_name', '$days', '$start_time', '$end_time', '$message', '$status')");
